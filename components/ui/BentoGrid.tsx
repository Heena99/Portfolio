...
export const BentoGridItem = ({
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText("heenanankani99@gmail.com");
    setCopied(true);
  }
  return (
    <div
    ...
    >
      <div className={`${id === 6 && "flex justify-center"} h-full`}>
        ...
        >
          ...
          {id === 3 && (
            <div className="flex gap-1 lg:gap-5 w-fit absolute -right-3 lg:-right-2 lg:scale-[85%]">
              <div className="flex flex-col gap-3 lg:gap-8">
                {['React.js', 'Next.js', 'Redux'].map((item) =>
